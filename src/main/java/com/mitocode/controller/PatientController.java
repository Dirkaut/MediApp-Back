...
public class PatientController {
    ...
    @GetMapping("signals/{idPatient}")
    public ResponseEntity<List<SignalDTO>> getSignals(@PathVariable("idPatient") Integer id){
        Patient obj = service.findById(id);
        List<SignalDTO> signals = obj.getSignals().stream().map(s -> modelMapper.map(s, SignalDTO.class)).toList();
